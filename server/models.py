...
class Employee(db.Model):
    ...
    #'secondary' indicates that the relationship is  implemented through the employee_meetings table
...
class Project(db.Model):
    ...
    #!The first argument indicates the relationship property we intend to use as 'connector' and the second argument indicates the name of the model we're trying to connect to
